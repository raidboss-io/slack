...
func TestSocketmodeHandler_Handle(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/raidboss-io/slack/socketmode.middleware",
		}, {
			...
			want: "github.com/raidboss-io/slack/socketmode.defaultmiddleware",
		},
	}
...
func TestSocketmodeHandler_HandleInteraction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/raidboss-io/slack/socketmode.middleware_interaction",
		}, {
...
func TestSocketmodeHandler_HandleEvents(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/raidboss-io/slack/socketmode.middleware_eventapi",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
...
func TestSocketmodeHandler_HandleInteractionBlockAction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/raidboss-io/slack/socketmode.middleware_interaction_block_action",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
...
func TestSocketmodeHandler_HandleSlashCommand(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/raidboss-io/slack/socketmode.middleware_slach_command",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
